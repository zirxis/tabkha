    ...
    const categories = [
        {
            ...
            popular: ['كسرة محشية ', 'طجين', 'كسكسي', 'شخشوخة']
        },
        {
            id: 'healthy',
            name: 'وجبات صحية',
        ...
        questions: [
            {
                ...
                options: [
                    { value: 'traditional', text: 'مطبخ عربي تقليدي', icon: '🏠', description: 'كسرة محشية , طجين, كسكسي, شخشوخة' },
            ...
            },
            {
                ...
                options: [
                    { value: 'economy', text: 'اقتصادي', icon: '💰', description: '200-400 دينار شهرياً' },
                    { value: 'standard', text: 'معتدل', icon: '💳', description: '400-600 دينار شهرياً' },
                    { value: 'premium', text: 'ممتاز', icon: '💎', description: '600-800 دينار شهرياً' },
                    { value: 'luxury', text: 'فاخر', icon: '👑', description: '800+ دينار شهرياً' }
                ]
            }
        ]
    };
    ...
    const chefs = [
        {
            ...
            priceRange: '25-35 دينار',
            match: 95,
            highlights: ['خبرة 15 سنة', 'أطباق جزائرية أصيلة', 'مناسبات واحتفالات']
        },
        {
            id: 'sara',
            name: 'سارة أحمد',
    ...
    element.innerHTML = `
        <div class="flex justify-between items-center">
            ...
            <div class="text-right">
                <div class="text-lg font-bold text-warm-orange">+${addon.price} دينار</div>
        ...
        pricingDisplay.innerHTML = `
            <div class="pricing-breakdown">
                <div class="text-center mb-6">
                    <div class="text-4xl font-bold text-warm-orange mb-2">${totalPricePerMeal.toFixed(0)} دينار</div>
                ...
                <div class="space-y-3 text-sm">
                    <div class="flex justify-between">
                        ...
                        <span class="font-bold">${weeklyTotal.toFixed(0)} دينار</span>
                    </div>
                    <div class="flex justify-between">
                        <span>الإجمالي الشهري:</span>
                        <span class="font-bold">${monthlyTotal.toFixed(0)} دينار</span>
                    </div>
                    ${plan.frequency !== 'daily' ? `
                        <div class="bg-green-50 p-3 rounded-lg mt-4">
                            ...
                            <div class="text-green-500 text-xs mt-1">توفير شهري: ${Math.round((basePrice - pricePerMeal) * totalMeals * 4)} دينار</div>
                        </div>
                    ` : ''}
                </div>
            </div>
    ...
    const chefs = [
        {
            ...
            priceRange: '25-35 دينار',
            description: 'طباخة منزلية متمرسة، متخصصة في الأطباق التقليدية الجزائرية مع خبرة 15 عام في الطبخ المنزلي. أقدم وجبات لذيذة وصحية بمكونات طازجة.',
            cuisine: ['traditional', 'family'],
            location: 'الجزائر - حي النسيم',
